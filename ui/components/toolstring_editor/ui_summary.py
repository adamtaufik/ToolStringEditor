...
class SummaryWidget(QWidget):
    ...
    def __init__(self, dropzone, parent=None):
        ...
        self.max_od_icon, self.max_od_label, self.max_od_value, self.max_od_metric = self.create_summary_item("Max OD", "icon_od")
        ...
        self.layout.addWidget(self.max_od_icon, 0, 0, alignment=Qt.AlignmentFlag.AlignRight)
